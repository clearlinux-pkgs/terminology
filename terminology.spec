...
Version  : 1.4.1
Release  : 2
URL      : https://download.enlightenment.org/rel/apps/terminology/terminology-1.4.1.tar.xz
Source0  : https://download.enlightenment.org/rel/apps/terminology/terminology-1.4.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558944143

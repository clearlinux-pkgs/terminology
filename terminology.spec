...
Version  : 1.12.1
Release  : 12
URL      : https://download.enlightenment.org/rel/apps/terminology/terminology-1.12.1.tar.xz
Source0  : https://download.enlightenment.org/rel/apps/terminology/terminology-1.12.1.tar.xz
...
%prep
%setup -q -n terminology-1.12.1
cd %{_builddir}/terminology-1.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641319677
...
cp %{_builddir}/terminology-1.12.1/COPYING %{buildroot}/usr/share/package-licenses/terminology/5c8dfc3f40802aaafd2043265ef330b2fedcf090

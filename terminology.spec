...
Source0  : https://download.enlightenment.org/rel/apps/terminology/terminology-1.6.0.tar.xz
...
%prep
%setup -q -n terminology-1.6.0
cd %{_builddir}/terminology-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574009283
...
cp %{_builddir}/terminology-1.6.0/COPYING %{buildroot}/usr/share/package-licenses/terminology/aea52a857a856589a382d2b810dd986e8f627eb3
...
/usr/share/package-licenses/terminology/aea52a857a856589a382d2b810dd986e8f627eb3

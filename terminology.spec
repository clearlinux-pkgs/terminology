...
Source0  : https://download.enlightenment.org/rel/apps/terminology/terminology-1.12.0.tar.xz
...
%prep
%setup -q -n terminology-1.12.0
cd %{_builddir}/terminology-1.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641240177
...
cp %{_builddir}/terminology-1.12.0/COPYING %{buildroot}/usr/share/package-licenses/terminology/5c8dfc3f40802aaafd2043265ef330b2fedcf090

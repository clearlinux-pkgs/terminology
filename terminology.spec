...
Source0  : https://download.enlightenment.org/rel/apps/terminology/terminology-1.13.0.tar.xz
...
%prep
%setup -q -n terminology-1.13.0
cd %{_builddir}/terminology-1.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669938791
